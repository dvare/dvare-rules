...
public class Function extends OperationExpression {
    static Logger logger = LoggerFactory.getLogger(com.dvare.expression.operation.validation.Function.class);
    ...
    public com.dvare.expression.operation.validation.Function copy() {
        return new com.dvare.expression.operation.validation.Function();
    }
